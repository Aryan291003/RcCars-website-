...
const SecondPanel = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-start py-0 pl-[15px] pr-0 box-border max-w-full mt-[-527.8px] text-left text-13xl text-wwwhorizonhobbycom-supernova font-wwwhorizonhobbycom-semantic-heading-3 ${className}`}
    >
      <div className="bg-wwwhorizonhobbycom-mine-shaft border-wwwhorizonhobbycom-mercury border-b-[1px] border-solid box-border flex flex-row items-start justify-start py-[199px] px-[60px] min-h-[1498px] max-w-[102%] z-[1] mq800:pl-[30px] mq800:pr-[30px] mq800:pb-[84px] mq800:box-border mq1325:pt-[547.8px] mq1325:pb-[129px] mq1325:box-border">
        <div className="h-[986px] flex flex-row items-start justify-start pt-[340px] px-0 pb-0 box-border max-w-[1320px] mq800:h-auto mq1125:pt-[547.8px] mq1125:box-border mq1325:max-w-full">
          <div className="flex flex-row items-start justify-start max-w-[1320px] shrink-0 mq1325:max-w-full">
            <div className="w-[1320px] bg-wwwhorizonhobbycom-mine-shaft flex flex-row items-end justify-center flex-wrap content-end pt-[42px] px-12 pb-12 box-border gap-0 max-w-full mq800:pt-[547.8px] mq800:pb-[31px] mq800:box-border mq1325:pl-6 mq1325:pr-6 mq1325:box-border">
              <div className="flex-1 flex flex-col items-start justify-start pt-0 pb-[76.4px] pl-[15px] pr-1.5 box-border gap-[25.7px] min-w-[335px] max-w-[660px] mq800:pb-[50px] mq800:box-border mq800:max-w-full">
                ...
                <div className="self-stretch flex flex-row items-start justify-start gap-[18px] max-w-full text-3xl font-wwwhorizonhobbycom-semantic-item mq800:flex-wrap">
                  ...
                  <div className="flex-1 flex flex-col items-start justify-start pt-px px-0 pb-0 box-border min-w-[354px] max-w-full mq800:min-w-full">
                    <div className="self-stretch flex flex-col items-start justify-start gap-[22.7px] max-w-full">
                      <div className="self-stretch flex flex-col items-start justify-start gap-[8.7px]">
                        <h3 className="m-0 relative text-inherit leading-[26.4px] font-extrabold font-inherit inline-block min-w-[106px] shrink-0 mq450:text-lg mq450:leading-[21px]">
                          In The Box
                        </h3>
                        <div className="self-stretch flex flex-col items-start justify-start shrink-0 text-sm text-wwwhorizonhobbycom-white">
                          ...
                          <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-[7px] gap-[7px]">
                            ...
                            <div className="self-stretch relative leading-[21px]">
                              <ul className="m-0 font-inherit text-inherit pl-[19px]">
                                <li>
                                  (1) Spektrum™ Firma™ 100A Smart Waterproof*
                                  ESC
                                </li>
                              </ul>
                            </div>
                            <div className="self-stretch relative leading-[21px]">
                              <ul className="m-0 font-inherit text-inherit pl-[19px]">
                                <li>
                                  (1) Spektrum™ Firma™ 3660 3900Kv Brushless
                                  Motor
                                </li>
                              </ul>
                            </div>
                          ...
                          <div className="self-stretch flex flex-col items-start justify-start gap-[7px]">
                            <div className="self-stretch relative leading-[21px]">
                              <ul className="m-0 font-inherit text-inherit pl-[19px]">
                                <li>
                                  (1) Spektrum™ SPMS651 7kg Waterproof*
                                  Metal-Geared Digital Servo
                                </li>
                              </ul>
                            </div>
                            <div className="self-stretch relative leading-[21px]">
                              <ul className="m-0 font-inherit text-inherit pl-[19px]">
                                <li>
                                  (1) 1/8 INFRACTION 4X4 3S BLX 4WD Manual
                                </li>
                              </ul>
                            </div>
                          </div>
